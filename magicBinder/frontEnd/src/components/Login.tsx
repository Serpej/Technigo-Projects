  ...
  return(
    ...
    >
      ...
      >
        ...
        >
          <form
            onSubmit={(e) => onLoginSubmit(e, email, password, navigate, setErrorMessage)}
          ...
          >
            ...
            >
              ...
              <input
                className="flex-1 text-pitch-black bg-sky-soap pl-2 m-1 rounded-sm border border-baltic-blue"
                type="email"
                name="Email"
                id="email"
